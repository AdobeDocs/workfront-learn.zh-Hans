...
[!DNL My Updates] 页面通过显示分配给您的任何审批请求，以及涉及您的更新，使事情变得简单。当您登录 Workfront 时，默认情况下会为审阅许可证用户加载此页面，除非您的组织的系统管理员设置了不同的登陆页面。
...
您使用哪个部分来管理审批请求取决于您组织的审阅和审批工作流。请咨询您的经理、系统管理员或内部 Workfront 团队，以确定您应该使用哪个部分来最好地支持您的工作流。
