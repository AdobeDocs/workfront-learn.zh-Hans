...
* **Portfolio创建：**&#x200B;项目组合是通过导航到Portfolio部分，单击“新建Portfolio”并分配Portfolio Manager创建的。 创建者&#x200B;和管理者最初具有独占访问权限。  
* **访问管理：**&#x200B;项目组合可以与其他人共享，授予可自定义的访问级别（例如，仅查看），这还可以扩展对项目组合中所有项目和项目的访问权限。  
* **项目和程序管理：**&#x200B;可以直接在项目组合中添加或创建项目，但每个项目只能属于一个项目组合。 项目群&#x200B;是项目的集合，也可以创建或移动到项目组合中，转移所有关联的项目。  
* **业务案例准备：**&#x200B;为每个项目创建业务案例对于组合优化中的有效比较和决策至关重要。  
