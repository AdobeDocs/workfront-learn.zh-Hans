...
本视频概述了如何在Workfront中导航和管理项目页面。 主要&#x200B;功能包括：

* **项目标题：**&#x200B;显示完成百分比、项目经理、计划完成日期、项目条件和状态等重要信息。 状态&#x200B;有助于跟踪项目的阶段并触发通知。  
* **痕迹导航导航：**&#x200B;显示项目在组织的项目和项目组合中的位置，其中带有可点击链接以方便导航。  
* **收藏夹和菜单：**&#x200B;收藏夹星形书签用于快速访问项目，而菜单提供编辑详细信息、复制项目和重新计算时间表等选项。  
* **任务列表：**&#x200B;表示项目计划中的步骤。 使用&#x200B;快速筛选器来查找任务，使用内联编辑来快速进行更改，使用任务摘要面板来了解详细信息。 单&#x200B;击任务名称将打开其专用页面。  
* **左侧面板：**&#x200B;提供对各种项目部分的访问权限，如详细信息、更新和文档。 系&#x200B;统管理员可以自定义面板。  
* **更新分区：**&#x200B;集中有关项目的通信，允许标记用户、回复评论和查看任务、问题和文档的汇总更新。  
* **文档部分：**&#x200B;允许上载和管理项目相关的文件和校样。 附加到任务的&#x200B;文档会汇总到项目级别以便轻松访问。  
...
* **项目标题概述：**&#x200B;快速访问关键项目详细信息，如完成百分比、项目经理、到期日期、状态和条件。 状态&#x200B;还控制通知和工作流暂存。  
* **任务管理：**&#x200B;使用任务列表跟踪项目步骤，应用快速筛选器查找任务并进行内联编辑。 通过摘要面板或任务页面访问&#x200B;详细的任务信息。  
* **痕迹导航导航：**&#x200B;使用痕迹导航跟踪中的可单击链接在组织内导航项目层次结构。  
* **集中式更新：**&#x200B;任务、问题和文档的所有更新汇总到项目更新部分，从而简化通信和跟踪。  
* **文档组织：**&#x200B;在文档部分上载和管理项目相关的文件和校样，确保相关文档已附加到任务以简化协作。  
