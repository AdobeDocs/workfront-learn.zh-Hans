...
last-substantial-update: '2024-10-04T00:00:00.000Z'
...
* **委派任务和问题：**&#x200B;用户可以通过“我的任务”小组件中的“委派”按钮，在指定时间段内将其所有任务和问题一起（而不是单独）委派给单个人员。 委派&#x200B;可以有结束日期或没有结束日期进行设置，并且可以手动停止。
* **委托审批：**&#x200B;可以使用等待我的审批小组件中的“委托审批”按钮委托项目、任务和问题的审批。 但&#x200B;是，无法委托审批文档、验证或时间表。
* **通知：**&#x200B;管理员可以启用委托的任务、问题和审批的电子邮件通知，以便在分配或停止委托时通知委托人和委托人。
* **跟踪委托：**&#x200B;系统中已标记委托的任务和审批，显示委托人和受委托人。 与批准相关的&#x200B;更新将显示在“更新”选项卡中，并且可以在“系统活动”选项卡中查看系统活动。
