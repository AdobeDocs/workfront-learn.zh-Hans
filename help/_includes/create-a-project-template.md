...
![主菜单中的 Blueprint](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-01.png)
...
![Blueprint 清单](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-02.png)

[!UICONTROL Details] 屏幕解释了有关 Blueprint 的更多信息，其中包括安装历史记录（如果已安装 Blueprint）。

![关于使用 Blueprint 的详细信息](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-03.png)

如果 Blueprint 已安装，您可以单击 **[!UICONTROL See details]** 获取已创建的模板以及为支持该模板而创建的任何其他对象的链接。

![关于安装 Blueprint 的详细信息](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-04.png)
