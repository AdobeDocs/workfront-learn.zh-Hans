...
要完成Workfront Fusion培训教程中的练习，您需要一个Workfront支持环境，在整个培训过程中也称为“**Workfront试用**”。 如果您已经有一个测试版，我们建议使用新的测试版进行此次培训。

填写[该表格](https://survey.adobe.com/jfe/form/SV_71xcV8UByyVwgBg)，请求获得测试版。 填写表单时，它将要求您提供&#x200B;**Adobe认证配置文件电子邮件**。 如果您还没有用户档案，请转到[Adobe认证网站](https://certification.adobe.com/#)并创建用户档案。
