...
To complete the exercises in the Workfront Fusion training tutorials, you will need a Workfront enablement environment, also referred to as a &quot;**Workfront Test Drive**&quot; throughout this training. 如果您已经有一个测试版，我们建议使用新的测试版进行此次培训。

填写[该表格](https://survey.adobe.com/jfe/form/SV_71xcV8UByyVwgBg)，请求获得测试版。When you fill out the form it will ask you to provide your **Adobe Certification profile email**. If you don&#39;t already have one, go to the [Adobe Certification site](https://certification.adobe.com/#) and create a user profile.
