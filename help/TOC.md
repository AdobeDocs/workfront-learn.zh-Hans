...
+ 管理和设置 {#administration-and-setup}
   ...
   + 创建和管理用户 {#create-and-manage-users}
      ...
      + [创建个人用户](administration-and-setup/create-and-manage-users/create-an-individual-user-profile.md)
...
+ 自定义数据 {#custom-data}
   ...
   + 计算表达式 {#calculated-expressions}
      ...
      + [使用 ISBLANK 和 CONTAINS 表达式](custom-data/calculated-expressions/isblank-and-contains.md)
...
+ 报告 {#reporting}
   + 基本报告 {#basic-reporting}
      ...
      + [创建一个基本过滤器活动](reporting/basic-reporting/create-a-basic-filter-activity.md)
   ...
   + 已优化的分析 {#enhanced-analytics}
      ...
      + [将 [!UICONTROL analytics] 添加到布局模板](reporting/enhanced-analytics/3-adding-analytics-to-layout-templates.md)
...
+ Fusion {#fusion}
   ...
   + 练习 {#exercises}
      + [初始场景设计](fusion/12-exercises/initial-scenario-design.md)
      + [超越基本映射](fusion/12-exercises/beyond-basic-mapping.md)
      ...
      + [切换功能](fusion/12-exercises/switch-function.md)
      + [切换模块](fusion/12-exercises/switch-module.md)
