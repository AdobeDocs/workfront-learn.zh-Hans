...
* **元数据架构**——架构是一组元数据字段，用于 [!UICONTROL Workfront DAM] 中的资源。 这些字段可以包括版权、创建者和位置。 如果您使用第三方应用程序添加元数据，请考虑您希望如何将这些字段映射到 [!UICONTROL Workfront DAM]。
...
为了取得长期成功，关键是要进行规划——在开始设置之前对系统结构进行规划，规划元数据架构，规划最终用户培训，以及规划持续的维护工作。
