...
* 确保在执行新流程或软件（例如Adobe Workfront）时，每月至少花费1小时沟通“为什么？”
...
如果不必为用户创建有关Workfront的培训，请不要这样做。 当然，您可以创建自己的培训，但如果您没有时间自己动手或花钱购买定制培训，那么Experience League上就提供了非常好的资源，无论您的用户扮演什么角色，都可以让他们启动并运行
...
我们最成功的客户制定了一种定期收集反馈的节奏，以了解可能阻碍更好地采用 Workfront 解决方案的因素。 收集反馈数据有助于管理员找到合适的资源来帮助进行改进。 该《采用调查指南》逐步介绍了对 Workfront 用户进行调查的执行、衡量、规划和审阅阶段。
