...
通过与外部供应商一同创建一个公司，您可以允许这些供应商进入 Workfront，审阅为他们构建的内容或产品的进度，同时限制他们在系统中的访问权限。
...
在Workfront中共享项目、报表等项时，使用更大的组织单位（如组和团队）意味着您可以快速、轻松地与一组选定的人员同时共享对象。 将单个用户的名称添加到共享窗口可能会很麻烦并且十分耗时。
