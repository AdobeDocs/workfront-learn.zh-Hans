...
Scrum方法包含灵活性模型，但与其他方法有所不同，因为它为团队中的成员（如产品所有者、浮渣主等）定义了角色，并定义了用于定义和完成工作的实践。
...
在整理积压工作并确定优先级后，就可以规划迭代了。 （许多组织会交替使用“冲刺”和“迭代”一词。） 团队根据认为已准备好要完成的故事来决定要完成的故事。 团队分配任务，并决定开发周期的持续时间。
