...
如果有可能，我们鼓励您与组织中的其他人合作来审阅和记录这些元素，并在出现任何重大更改时保持您的文档最新。 您实例中未来的管理员会非常感谢您！
...
这包括开展利益相关者访谈，并审阅任何现有文档，以了解组织内的各个组如何利用 Workfront。

如果您从技术角度不熟悉 Workfront，请参加系统管理员培训。 这提供了对 Workfront 中不同设置如何发挥作用并影响每个工具以及潜在的每个用户的必要洞察。
